...
import LogisticaIncidenciaFormulario from "./LogisticaIncidenciaFormulario";
...
firebaseDb.child(`tareas/logistica/${currentId}`).set(
  ...
  <div className="container">
    <h1 className="display-4 text-center">Listado de Incidencias de Logistica</h1>
  </div>
</div>
 <div className="row">
 <div className="col-md-5">
     <LogisticaIncidenciaFormulario {...({addOrEdit, currentId, tareaObjects})}/>
 </div>
...
export default LogisticaIncidencias;