...
import RecursosHumanosIncidenciaFormulario from "./RecursosHumanosIncidenciaFormulario";
...
const RecursosHumanosIncidencia=()=>{
...
firebaseDb.child(`tareas/recursos-humanos/${currentId}`).set(
  ...
  <div className="container">
    <h1 className="display-4 text-center">Listado de Incidencias de Recursos Humanos</h1>
  </div>
</div>
 <div className="row">
 <div className="col-md-5">
     <RecursosHumanosIncidenciaFormulario {...({addOrEdit, currentId, tareaObjects})}/>
 </div>
...
export default RecursosHumanosIncidencia;